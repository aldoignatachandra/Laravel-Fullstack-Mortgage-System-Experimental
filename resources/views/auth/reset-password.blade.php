...
@section('title', 'Reset Password - Tedja')
    ...
    <div
        ...
        <div
            ...
            <div style="text-align: center; margin-bottom: 24px;">
                <h1 style="font-weight: 700; font-size: 24px; line-height: 36px; margin-bottom: 4px;">Reset Password</h1>
                <p style="font-weight: 600; color: #8F91A2; font-size: 14px;">Create a new password for your account</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}" style="display: flex; flex-direction: column; gap: 14px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 6px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" readonly
                            style="width: 100%; appearance: none; outline: none; border-radius: 9999px; border: 1px solid #F2F2F4; padding: 12px 16px 12px 48px; font-weight: 600; font-size: 14px; box-sizing: border-box; background-color: #F2F2F4;">
                    </div>
                    @error('email')
                ...
                <div style="display: flex; flex-direction: column; gap: 6px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" id="toggle-password" style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; padding: 0; display: flex; align-items: center; justify-content: center;">
                            {{-- Eye Icon (Show) --}}
                            <svg id="eye-show" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8F91A2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
                            {{-- Eye Off Icon (Hide) --}}
                            <svg id="eye-hide" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8F91A2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: none;">
                ...
                <div style="display: flex; flex-direction: column; gap: 6px;">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="password" name="password_confirmation" id="password-confirm" required autocomplete="new-password"
                            style="width: 100%; appearance: none; outline: none; border-radius: 9999px; border: 1px solid #F2F2F4; padding: 12px 48px 12px 48px; font-weight: 600; font-size: 14px; box-sizing: border-box;">
                        {{-- Toggle Password Visibility --}}
                        <button type="button" id="toggle-password-confirm" style="position: absolute; right: 16px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; padding: 0; display: flex; align-items: center; justify-content: center;">
                            {{-- Eye Icon (Show) --}}
                            <svg id="eye-show-confirm" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8F91A2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
                            {{-- Eye Off Icon (Hide) --}}
                            <svg id="eye-hide-confirm" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8F91A2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: none;">
                                <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
                                <line x1="1" y1="1" x2="23" y2="23"></line>
                            </svg>
                        </button>
            ...
            <div style="margin-top: 24px; text-align: center;">
                <a href="{{ route('login') }}"
                    style="display: inline-flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 600; color: #8F91A2; text-decoration: none;">
