...
@section('title', 'Pay Installment - Experimental Project')
@section('content')
        ...
        <div class="h-screen w-full overflow-y-auto pt-[30px] px-[30px]">
            ...
            <main class="flex w-full flex-col justify-center gap-[30px] pt-[28px] pb-[70px]">
                ...
                <header class="flex flex-col gap-[6px]">
                    <h1 class="text-[26px] font-bold leading-[39px]">
                        Mortgage Details
                    </h1>
                    <p class="text-sm leading-[21px] text-tedja-secondary">
                        Tedja always make your family comfortable
                    </p>
                </header>
                <div class="flex gap-[30px]">
                    ...
                    <div class="w-full">
                        <form id="paymentForm" class="flex w-full flex-col gap-[30px]">
                            @csrf
                            ...
                            <section id="KPRPaymentDetails"
                                ...
                                <div class="flex items-center justify-between">
                                    <h4 class="font-semibold text-lg leading-[27px]">
                                        KPR Payment Details
                                    </h4>
                            ...
                            <section id="MakeAPayment"
                                ...
                                <div class="flex items-center gap-[6px] pl-[7px] mx-auto">
                                    ...
                                    <p class="font-semibold">
                                        All your privacy data secured with our system
                                    </p>
                                </div>
                                <hr class="border-[#F2F2F4]" />

                                <button type="submit" id="pay-button"
                                    class="bg-tedja-green rounded-full py-[14px] w-full flex justify-center font-semibold">
